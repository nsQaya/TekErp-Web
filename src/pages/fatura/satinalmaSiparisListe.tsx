...
const  SatinalmaSiparisListe =  ({ baseApi, navigatePath }: IListeProps) => {
  ...
  const confirmDelete = useCallback(async () => {
    if (itemToDelete) {
      try {
        ...
        await api.siparis.delete(itemToDelete.belgeId as number);//transaction yapısı bacend e yüklendi.
  ...
  return (
    <div className="container-fluid">
      ...
      <ConfirmDialog
        ...
        rejectLabel="Hayır"
      />
      <AppBreadcrumb title="Satın Alma Sipariş Listesi" />
      <div className="row">
...
export default SatinalmaSiparisListe;